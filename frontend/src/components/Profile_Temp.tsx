        ...
        <section className="container mx-auto px-4 mt-16 relative">
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="w-full md:w-1/2 relative flex justify-start ml-[-150px]">
              <img src="/Vector3.png" alt="Vector3" className="absolute top-[-20px] right-[-100px] w-[400px] h-auto z-0" />
              <div className="relative w-[500px] h-[500px] p-6 z-10 overflow-visible">
